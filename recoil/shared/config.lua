...
--// Recoil Geter //--
Config.EnableRecoilGeter            = true
Config.DisplayAmmoThisFrame         = false
Config.GeterInterval                = 0
Config.ShakeCamList                 = {
    {name = "WEAPON_STUNGUN",           value = 0.5},
    {name = "WEAPON_FLAREGUN",          value = 0.1},
    {name = "WEAPON_SNSPISTOL",         value = 0.02},
    {name = "WEAPON_SNSPISTOL_MK2",     value = 0.025},
    {name = "WEAPON_PISTOL",            value = 0.3},
    {name = "WEAPON_PISTOL_MK2",        value = 0.2},
    {name = "WEAPON_APPISTOL",          value = 0.08},
    {name = "WEAPON_PISTOL50",          value = 0.10},
    {name = "WEAPON_HEAVYPISTOL",       value = 0.3},
}
